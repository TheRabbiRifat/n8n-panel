...
class ContainerController extends Controller
{
    ...
    protected $containerManagementService;

    public function __construct(DockerService $dockerService, BackupService $backupService, ContainerManagementService $containerManagementService)
    {
    ...
    public function toggleRecovery(Request $request, $id)
    {
        ...
        try {
            $this->containerManagementService->recreateContainer($container);
