            ...
            <div class="card-body">
                <form action="{{ route('packages.store') }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="ram_limit" name="ram_limit" placeholder="e.g. 512m or 1g" value="{{ old('ram_limit') }}">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="disk_limit" name="disk_limit" placeholder="e.g. 10g" value="{{ old('disk_limit') }}">
